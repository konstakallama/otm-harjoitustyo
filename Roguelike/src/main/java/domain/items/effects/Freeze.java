...
public class Freeze extends Effect {
    ...
    public Freeze(int duration, PlayerStats casterStats, String name) {
        super(name);
    ...
    public CommandResult applyEffectToEnemy(Enemy e) {
        ...
        e.freeze(duration);
        return new CommandResult(true, true, mdb.getHitWithFreezeMsg(this.sourceName, Math.round(100 * hitProb), e, duration));
    }
